		...
		while self.isOperatorControl() and self.isEnabled():
			...
			mecanum( self.stick.getX(), 
						self.stick2.getY(), 
							self.stick2.getX(), 
								wheelSpeed)
			#tank((self.stick.getY()*-1), (self.stick2.getY()*-1), wheelSpeed)
			...
			self.smartDs.putString("DB/String 2", "digR: " + str(self.rightSwitch.get())[0:5])   
			self.smartDs.putString("DB/String 3", "digL: " + str(self.leftSwitch.get())[0:5])
